			...
			?>
				<li class="results">
					...
					<p style="font-size: 12pt; margin-top: -10px;"> <span style="color: #b31b1b;font-weight:bold; ">Submitted On:</span><?php echo $date?></p>
			     	<p class='abstract' style="font-size: 12pt;"> <span style="color: #b31b1b;font-weight:bold; ">Abstract:</span><?php echo $abstract?></p><div align="right"><a data-toggle="modal" href="#<?php echo $id?>">more</a></div>
