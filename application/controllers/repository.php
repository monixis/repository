  ...
  */
  ...
  public function searchKeyWords()
    ...
    $key = $this -> input -> get('key');
		...
		$resultsLink = "http://35.162.165.138:8983/solr/repository/select?facet.field=Collection&facet.field=Year&facet.field=Department&facet.field=Tags&facet=on&indent=on&q=".$key."&wt=json";
